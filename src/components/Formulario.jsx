      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mb-4'>
          ...
          <input
            ...
            id='ciudad'
            name='ciudad'
            className=' rounded-md w-full py-1 px-2 mt-2 border text-white border-slate-500 outline-none shadow-md bg-transparent'
        ...
        <div className='mb-4'>
          ...
          <select
            name='pais'
            id='pais'
            className='text-gray-400 rounded-md w-full py-1.5 px-1 mt-2 border border-slate-500 outline-none shadow-md bg-transparent'
            onChange={datosBusqueda}
            value={pais}
          >
